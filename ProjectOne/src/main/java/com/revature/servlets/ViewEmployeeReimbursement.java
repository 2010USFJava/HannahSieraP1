...
public class ViewEmployeeReimbursement extends HttpServlet {
		...
		try { Class.forName("org.postgresql.Driver");
	     ...
	     public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException 
	      {  
	         ...
	         out.println("<p>Enter Employee ID</p>");   
	         ...
	         {  
	             ...
	             ResultSet rs = stmt.executeQuery("select * from reimbursement where employee_id= ?");
